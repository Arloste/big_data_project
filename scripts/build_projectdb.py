...
DATASET_PATH = "yellow_tripdata_2015-01_preprocessed.csv"
...
with psql.connect(CONN_STRING) as conn:
    ...
    with open(os.path.join("sql", "import_data.sql"),
        ...
        with open(os.path.join("data", DATASET_PATH),
                  mode="r", encoding="utf-8") as rides:
            cur.copy_expert(commands[0], rides)
